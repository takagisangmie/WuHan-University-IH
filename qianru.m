function qianru(cover_dir,stego_dir,payload,cover_QF,attack_QF)
% 
...
%     end
    ...
    [~, stc_msg,stc_n_msg_bits,~] = stc_pm1_pls_embed(int32(cover1), costs, uint8(msg2), H);
