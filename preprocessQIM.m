...
breakpoint = 1;
[~, name, x_ext] = fileparts(cover_Path);
after_zhihu = ['C:\Users\fuqin\Desktop\pic\test_zhihu\test3\after_channel\',name,x_ext];
F_STRUCT = jpeg_read(after_zhihu);
F_COEFFS = F_STRUCT.coef_arrays{1};
F_QUANT = F_STRUCT.quant_tables{1};
...
breakpoint = 1;
[~, name, x_ext] = fileparts(cover_Path);
after_zhihu = ['C:\Users\fuqin\Desktop\pic\test_wb\test1\after_channel\',name,x_ext];
F_STRUCT = jpeg_read(after_zhihu);
F_COEFFS = F_STRUCT.coef_arrays{1};
F_QUANT = F_STRUCT.quant_tables{1};
